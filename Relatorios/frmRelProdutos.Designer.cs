namespace SistemaHoteleiro.Relatorios
{
    partial class frmRelProdutos
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.dataSet1 = new SistemaHoteleiro.DataSet1();
            this.produtosTableAdapter = new SistemaHoteleiro.DataSet1TableAdapters.produtosTableAdapter();
            this.produtosFornecedoresBindingSource = new System.Windows.Forms.BindingSource(this.components);
            this.produtosFornecedoresTableAdapter = new SistemaHoteleiro.DataSet1TableAdapters.ProdutosFornecedoresTableAdapter();
            ...
            this.reportViewer1.LocalReport.ReportEmbeddedResource = "SistemaHoteleiro.Relatorios.RelProdutos.rdlc";
            this.reportViewer1.Location = new System.Drawing.Point(0, 0);
            this.reportViewer1.Name = "reportViewer1";
            this.reportViewer1.ServerReport.BearerToken = null;
            this.reportViewer1.Size = new System.Drawing.Size(670, 530);
            ...
            this.produtosFornecedoresBindingSource.DataSource = this.dataSet1;
            // 
        ...
        private DataSet1TableAdapters.ProdutosFornecedoresTableAdapter produtosFornecedoresTableAdapter;
    }
}